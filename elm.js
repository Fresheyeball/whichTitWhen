...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var renderFeeding = function (feeding) {
      var showDate = function (_p0) {    return $Basics.toString($Date.toTime(_p0));};
      var message = function () {
         var _p1 = feeding;
         switch (_p1.ctor)
         {case "LeftBreast": return A2($Basics._op["++"],"Left at: ",showDate(_p1._0));
            case "RightBreast": return A2($Basics._op["++"],"Right at: ",showDate(_p1._0));
            default: return A2($Basics._op["++"],"Finished at: ",showDate(_p1._0));}
      }();
      return A2($Html.div,_U.list([]),_U.list([$Html.text(message)]));
   };
   var view = function (feedings) {    return A2($Html.div,_U.list([]),A2($List.map,renderFeeding,feedings));};
   var Done = function (a) {    return {ctor: "Done",_0: a};};
   var RightBreast = function (a) {    return {ctor: "RightBreast",_0: a};};
   var LeftBreast = function (a) {    return {ctor: "LeftBreast",_0: a};};
   var main = view(_U.list([LeftBreast($Date.fromTime(1451604066913))]));
   return _elm.Main.values = {_op: _op,LeftBreast: LeftBreast,RightBreast: RightBreast,Done: Done,renderFeeding: renderFeeding,view: view,main: main};
};
